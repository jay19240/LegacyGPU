...
class BattleAreaFighter extends Gfx3Transformable {
  ...
  async loadFromCharacter(character) {
    ...
    if (character) {
      ...
      this.effectSprite = new Gfx3SpriteJAS();
      this.effectSprite.loadFromFile('examples/rpg/sprites/effects.jas');
      this.effectSprite.setTexture(await gfx3TextureManager.loadTexture('examples/rpg/sprites/effects.png'));
