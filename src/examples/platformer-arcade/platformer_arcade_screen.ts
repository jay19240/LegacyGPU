...
class PlatformerArcadeScreen extends Screen {
  tileMap: Gfx2TileMap;
  ...
  async onEnter() {
    await this.tileMap.loadFromFile('examples/platformer/map.jtm');
    ...
    this.foregroundLayer.loadFromTileMap(this.tileMap, 2);
		...
		parallaxSprite.setTexture(await gfx2TextureManager.loadTexture('examples/platformer/background.png'));
