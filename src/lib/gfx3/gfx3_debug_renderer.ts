...
class Gfx3DebugRenderer extends Gfx3RendererAbstract {
   ...
   * 
   * @param {mat4} matrix - The transformation matrix.
   * @param x1 - Where the line start on x axis.
   * @param y1 - Where the line start on y axis.
   * @param z1 - Where the line start on z axis.
   * @param x2 - Where the line end on x axis.
   * @param y2 - Where the line end on y axis.
   * @param z2 - Where the line end on z axis.
   * @param r  - The red color component of the line.
   * @param g  - The green color component of the line.
   * @param b  - The blue color component of the line.
   */
